...
//                    if($sample.is(":hover"))
//                    {
//////                    alert("Itemlist hover is working");
//                    settings.scrollWheel.enabled = false;
//                    document.getElementById("itemlist1").innerHTML = "Item List (Hovered.)";
//                    }
//                    else
//                    {
//////                    alert("Itemlist exit is working");
//                    settings.scrollWheel.enabled = true;
//                    document.getElementById("itemlist1").innerHTML = "Item List (Ignored.)";
//                    }
//                });
...
// Scroll wheel.
				if (settings.scrollWheel.enabled)
                {
                        if (settings.scrollWheel.enabled == true)
                        {
                            alert("scrollWheel is Enabled");
                        };
                ...
                {
                    if (settings.scrollWheel.enabled == false)
                    {
                        alert("scrollWheel is Disabled");
                    };
                };