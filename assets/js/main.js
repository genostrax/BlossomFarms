...
//            function switch_scrollstatus(){
    ...
    $(document).ready(function()
    {
        if ($(".verticalScroll table").height() < ($(".verticalScroll").outerHeight(true) - $(".major").outerHeight(true)))
        {
            $('#itemlist').addClass('itemlistShort');
            
        }
        else
        {
            $('#itemlist').removeClass('itemlistShort');
        };
    });
...
//    if (skel.vars.mobile && $(".verticalScroll table").height() > (($(window).height())*2))
//    {
...
//        
//
//    var additems_position = $("#additems").offset().top;    
//    $(window).on('scroll', function()
//    {
//        var scrollTop = $(this).scrollTop(); // Live distance to the top while scrolling
//        $("#state1").text(scrollTop);
//
////        $('#logo, #itemlist, #additems, #contactdetails, #location').each(function()
//        $('#additems').each(function()
//        {
//            var topDistance = $(this).offset().top; //Calculate the position of the trigger element
//        $("#state2").text(additems_position);
//
//            if (additems_position == additems_position)
//            {
//                var goHere = "#logo";
//                $("#state3").text("1");
//            }
